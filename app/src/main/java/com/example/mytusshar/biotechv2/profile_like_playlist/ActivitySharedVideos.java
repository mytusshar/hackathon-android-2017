...
/**
 * Created by mytusshar on 01-Apr-17.
 */
 ...
 */
public class ActivitySharedVideos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Shared Videos");
        ...
        playlistLayout = (LinearLayout)findViewById(R.id.shared_videos_layout);
        listView = (RecyclerView) findViewById(R.id.shared_list);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void onStart() {
        ...
        if(!haveNetworkConnection()){
            Snackbar snackbar = Snackbar.make(playlistLayout, "No Internet Connection Available....", Snackbar.LENGTH_LONG);
            snackbar.show();
        }else{
            getJSONData();
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void getJSONData(){
        ...
        JsonArrayRequest jsonRequest = new JsonArrayRequest(AppConfig.URL_SHARE_VIDEO_LIST,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                ///////////////////////////////////////////////////////////////
                                //preview URL is being used for getting "shared By"
                                //user name here only
