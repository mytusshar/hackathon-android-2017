...
public class AreasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        gridView = (RecyclerView) rootView.findViewById(R.id.areas_recycler_view);

        recyclerViewLayoutManager = new GridLayoutManager(getActivity(), 3);

        gridView.setLayoutManager(recyclerViewLayoutManager);

        adapter = new CustomGridAdapter(getActivity(), categoryModelList);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void getJSONData(){
        ...
        JsonArrayRequest jsonRequest = new JsonArrayRequest(AppConfig.URL_AREAS_LIST,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                categoryModel.setCategoryId(""+obj.getInt("areaId"));
                                categoryModel.setCategoryName(obj.getString("area"));
